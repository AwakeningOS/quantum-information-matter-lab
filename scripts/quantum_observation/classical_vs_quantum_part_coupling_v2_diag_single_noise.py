...
def main() -> None:
    ...
    result = {
        ...
        "notes": [
            "Diagnostic only; not QPU-ready.",
            "The current readout model is symmetric bit flip. Readout asymmetry remains a hardware concern but is not tested here.",
        ],
    }
